...
- **Practical PvE recommendations.** One gold ring marks the best current GCD action; softer green rings show valid maintenance, proc, interrupt, taunt, cooldown, and resource actions.
